...
!function ($) {
    ...
    var Typeahead = function (element, options) {
        ...
        if (options.scrollBar) {
            options.items = 100;
            options.menu = '<ul class="typeahead dropdown-menu shadow border-0" style="max-height:220px;overflow:auto;"></ul>';
        }

        // html content to display when no results are found
        options.resultNotFoundMsgBody = "<div><p>抱歉呢前辈，没有找到您想要的结果</p></div>";
    ...
    $.fn.typeahead.defaults = {
        ...
        scrollBar: false,
        alignWidth: true,
        menu: '<ul class="typeahead dropdown-menu shadow border-0"></ul>',
        item: '<li><a class="dropdown-item"></a></li>',
        valueField: 'id',
        displayField: 'name',
        autoSelect: true,
        onSelect: function () {
